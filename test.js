...
function GenerateWordsTable(){
  ...
  ////мусорные символы
  for (let i = 0; i < DumpHeight * DumpWidth - (WordCount * PasswordLength); i++) {
